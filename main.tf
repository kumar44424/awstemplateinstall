...
resource "aws_instance" "RHEL" {
 ...
 provisioner "remote-exec" {
    inline = [
      "echo yes | sudo yum install unzip;  sudo curl -L -O https://ibm.box.com/shared/static/feqe5yocqf9yamtp7qn3ps5zfxjt30u4.zip; sudo unzip feqe5yocqf9yamtp7qn3ps5zfxjt30u4.zip ; sudo chmod +x tf1.sh;sudo bash tf1.sh;"
    ]
  }
...
resource "aws_instance" "kali" {
 ...
 provisioner "remote-exec" {
    inline = [
      "echo yes | sudo apt install zip ; echo yes | sudo apt install unip; sudo curl -L -O https://ibm.box.com/shared/static/6oc31mh87tywrwwi5yc9fodor891q5py.zip; sudo unzip 6oc31mh87tywrwwi5yc9fodor891q5py.zip; sudo bash tf_kali.sh"
    ]
  }}
