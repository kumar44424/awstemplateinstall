...
resource "aws_instance" "kali" {
 ...
 provisioner "remote-exec" {
    inline = [
      "echo yes | sudo apt install zip ; echo yes | sudo apt install unip; sudo curl -L -O https://ibm.box.com/shared/static/6oc31mh87tywrwwi5yc9fodor891q5py.zip;sudo curl -L -O https://ibm.box.com/shared/static/i2hech8d74r6o0fvosip52btxf63dw8q.zip  ;sudo unzip i2hech8d74r6o0fvosip52btxf63dw8q.zip;sudo unzip odevtrqvhdmwaz6gypb2jkd856yldt4i.zip; sudo bash tf_kali.sh; sudo chmod +x CarbonBlackClientSetup-linux-v6.2.2.10003.sh; sudo bash CarbonBlackClientSetup-linux-v6.2.2.10003.sh"
    ]
  }}
